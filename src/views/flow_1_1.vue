<template>
  <div class="container">
    ...
    <div class="right1"><Table :data="mapData3" :title1="'数据接入'"></Table></div>
    <div class="right2"><Table :data="mapData2" :title1="'数据共享'"></Table></div>
...
lineData1.value = {
  categories: ['00:00', '1:25', '2:50', '4:15', '5:40', '7:05', '8:30','9:55','11:20','12:45','14:10','15:35','17:00','18:25','19:50','21:15','22:40','23:55'],
  value: [2.0, 2.2, 3.1, 3.4, 3.0, 3.0, 3.2,7.1,8.8,9.5,11.5,12.0,10.9,9.9,11.1,7.5,7.3,6.8],
  title: '交通流量趋势图',
  title2: '交通流量趋势'
}
</script>
