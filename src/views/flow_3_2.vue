...
lineData1.value = {
  categories: ['Road1', 'Road2', 'Road3', 'Road4', 'Road5', 'Road6', 'Road7','Road8'],
  value: [2.0, 2.4, 6.1, 7.4, 6.5, 10.0, 9.2,11.4],
  title: '主干道拥堵指数图',
  title2: '主干道平均拥堵指数'
}
lineData2.value = {
  categories: ['Road1', 'Road2', 'Road3', 'Road4', 'Road5', 'Road6', 'Road7','Road8'],
  value: [0.1, 0.15, 0.46, 0.55, 0.50, 0.78, 0.71,0.85],
  title: '事故风险预测图',
  title2: '事故指数'
}
...
.container {  display: grid;
  ...
  grid-template-areas:
    ...
    "left1 left1 left1 center1 center1 center1 center1 center1 center1 right right right"
    "left1 left1 left1 center1 center1 center1 center1 center1 center1 right right right"
    "left2 left2 left2 center1 center1 center1 center1 center1 center1 right right right"
